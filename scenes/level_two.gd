...
var dialogues_list = [ # because we need more dialogues than just that one at the beginning
	"res://dialogue/dialogue4.dialogue", 
	"res://dialogue/dialogue5.dialogue",
	"res://dialogue/dialogue6.dialogue"
]

#var horror_script = "res://scenes/horror_timers.gd"
#var horror_timer = load(horror_script)
...
func _ready(): 
	...
	randomize()
	horror_timers.visible = false
	while true:
		var t = randf_range(10, 20)
		await get_tree().create_timer(t).timeout
		horror_timers.visible = true
